...
import (
	...
	"github.com/tgoodwin/kamera/examples/cass-operator/serverconfig"
...
var SchemeGroupVersion = schema.GroupVersion{Group: "cassandra.datastax.com", Version: "v1beta1"}

func AddToScheme(s *runtime.Scheme) error {
	s.AddKnownTypes(SchemeGroupVersion, &CassandraDatacenter{}, &CassandraDatacenterList{})
