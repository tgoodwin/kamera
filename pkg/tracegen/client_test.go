...
func Test_Get(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, pod, event.GET, gomock.Any(), gomock.Any(), gomock.Any()).Times(1)
...
func Test_List(t *testing.T) {
	...
	for _, p := range podList.Items {
		mockEmitter.EXPECT().Emit(ctx, &p, event.LIST, gomock.Any(), gomock.Any(), gomock.Any()).Times(1)
	}
...
func Test_UpdateFail(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, pod, event.UPDATE, gomock.Any(), gomock.Any(), gomock.Any()).Times(0)
...
func Test_CreateSuccess(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, pod, event.CREATE, gomock.Any(), gomock.Any(), gomock.Any()).Times(1)
...
func Test_UpdateSuccess(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, gomock.AssignableToTypeOf(pod), event.UPDATE, gomock.Any(), gomock.Any(), gomock.Any()).Times(1)
	err := c.Update(ctx, pod)
	assert.NoError(t, err)
...
func Test_PatchFail(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, gomock.Any(), event.PATCH, gomock.Any(), gomock.Any(), gomock.Any()).Times(0)
...
func Test_PatchSuccess(t *testing.T) {
	...
	mockEmitter.EXPECT().Emit(ctx, gomock.Any(), event.PATCH, gomock.Any(), gomock.Any(), gomock.Any()).Times(1)
	err := c.Patch(ctx, pod, nil)
	assert.NoError(t, err)
