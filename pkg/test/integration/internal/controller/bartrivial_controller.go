...
type BarTrivialReconciler struct {
	client.Client
...
func (r *BarTrivialReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *BarTrivialReconciler) SetupWithManager(mgr ctrl.Manager) error {
